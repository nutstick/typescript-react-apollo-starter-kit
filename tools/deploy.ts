...
/**
 * Deploy the contents of the `/dist` folder to a remote server via Git.
 */
async function deploy() {
  ...
  await run(require('./dist').default); // eslint-disable-line global-require
  if (process.argv.includes('--static')) {
    ...
    await moveDir('dist/public', 'dist');
  }
