...
//   '/page',       // => dist/public/page.html
//   '/page/',      // => dist/public/page/index.html
//   '/page/name',  // => dist/public/page/name.html
//   '/page/name/', // => dist/public/page/name/index.html
// ];
const routes = [
  '/',
  '/contact',
...
async function render() {
  ...
  await Promise.all(routes.map(async (route, index) => {
    ...
    const dirName = path.join('dist/public', route.endsWith('/') ? route : path.dirname(route));
